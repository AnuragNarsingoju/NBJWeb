        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-2xl font-bold">NBJ Jewelry Management System</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#screenshots" className="text-gray-300 hover:text-white transition-colors">Screenshots</a></li>
        ...
        <div className="text-center mt-8 pt-8 border-t border-gray-800">
          ...
          <div className="mt-6 flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-8">
            <div className="flex items-center space-x-2">
              ...
              <a href="mailto:anuragnarsingoju@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors text-sm">
